...
const htmlPath = path.join(root, "docs/baby-ai-jobhunter-stardew-film.html");
const frameDir = "/private/tmp/baby-ai-jobhunter-stardew-frames";
const outDir = path.join(root, "output");
const outPath = path.join(outDir, "宝宝AI_jobhunter_星露谷风展示视频.mp4");
